...
Engineering reference for Music Tribe Finder. Describes _how the system is
built_ — modules, contracts, flows, and the invariants that hold it
together.
...
| Color contrast   | 4.5:1 body, 3:1 large text. Verified with axe-core. Never rely on color alone (energy bar has fill _and_ numeric label).                                                      |
